...
df_compensation.to_csv(
    "./Updates/BEA_NC_CA6N_Compensation_of_Employees.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_wages.to_csv("./Updates/BEA_NC_CA6N_Wages_and_Salaries.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_health.to_csv(
    "./Updates/BEA_NC_CA6N_Health_Care_and_Social_Assistance.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_info.to_csv("./Updates/BEA_NC_CA6N_Information.txt", sep="\t")
...
df_management.to_csv(
    "./Updates/BEA_NC_CA6N_Management_of_Companies_and_Enterprises.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_manufacturing.to_csv("./Updates/BEA_NC_CA6N_Manufacturing.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_mining.to_csv(
    "./Updates/BEA_NC_CA6N_Mining_Quarrying_and_Oil_and_Gas_Extraction.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_services.to_csv("./Updates/BEA_NC_CA6N_Other_Services.txt", sep="\t")
...
df_professional.to_csv(
    "./Updates/BEA_NC_CA6N_Professional_Scientific_and_Technical_Services.txt",
    sep="\t",
)
...
df_realestate.to_csv(
    "./Updates/BEA_NC_CA6N_Real_Estate_and_Rental_and_Leasing.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_retail.to_csv("./Updates/BEA_NC_CA6N_Retail_Trade.txt", sep="\t")
...
df_transportation.to_csv(
    "./Updates/BEA_NC_CA6N_Transportation_and_Warehousing.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_utilities.to_csv("./Updates/BEA_NC_CA6N_Utilities.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_wholesale.to_csv("./Updates/BEA_NC_CA6N_Wholesale_Trade.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_pension.to_csv(
    "./Updates/BEA_NC_CA6N_Employer_Contributions_for_Employee_Pension_and_Insurance_Funds.txt",
    sep="\t",
)
...
# Save as tab-delimited txt file for export to SSMS
df_social.to_csv(
    "./Updates/BEA_NC_CA6N_Employer_Contributions_for_Government_Social_Insurance.txt",
    sep="\t",
)
...
# Save as tab-delimited txt file for export to SSMS
df_gov.to_csv(
    "./Updates/BEA_NC_CA6N_Government_and_Government_Enterprises.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_private.to_csv(
    "./Updates/BEA_NC_CA6N_Private_Nonfarm_Compensation.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_farm.to_csv("./Updates/BEA_NC_CA6N_Farm_Compensation.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_nonfarm.to_csv("./Updates/BEA_NC_CA6N_Nonfarm_Compensation.txt", sep="\t")
...
df_supplement.to_csv(
    "./Updates/BEA_NC_CA6N_Supplements_to_Wages_and_Salaries.txt", sep="\t"
)
...
# Save as tab-delimited txt file for export to SSMS
df_food.to_csv(
    "./Updates/BEA_NC_CA6N_Accommodation_and_Food_Services.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_admin.to_csv(
    "./Updates/BEA_NC_CA6N_Administrative_and_Support_and_Waste_Management_and_Remediation_Services.txt",
    sep="\t",
)
...
# Save as tab-delimited txt file for export to SSMS
df_arts.to_csv(
    "./Updates/BEA_NC_CA6N_Arts_Entertainment_and_Recreation.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_construction.to_csv("./Updates/BEA_NC_CA6N_Construction.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_eduserv.to_csv("./Updates/BEA_NC_CA6N_Educational_Services.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_finance.to_csv("./Updates/BEA_NC_CA6N_Finance_and_Insurance.txt", sep="\t")
...
# Save as tab-delimited txt file for export to SSMS
df_forestry.to_csv(
    "./Updates/BEA_NC_CA6N_Forestry_Fishing_and_Related_Activities.txt", sep="\t"
)
