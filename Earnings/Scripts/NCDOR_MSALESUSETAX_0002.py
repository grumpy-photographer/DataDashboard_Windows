...
df = pd.read_excel(
    "https://files.nc.gov/ncdor/documents/reports/monthly_sales_11-20.xls", skiprows=9
)
...
# Rename columns
df = df.rename(columns={"County.1": "County", "and Purchases*": "11-01-20"})
df1 = df1.rename(columns={"County.1": "County", "and Purchases*.1": "11-01-20"})

# Append dataframes
df_list = [df, df1]
df_main = df.append(df_list)
df_main["Date"] = "11/01/2020"
...
df_main["11-01-20"] = df_main["11-01-20"].astype(float)
