...
df1 = df1.rename(columns = {'County.1':'County', 'Collections*.1':'Collections'})
# append dataframes
df_list = [df, df1]
...
df_master0['Collections'] = df_master0['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master1['Collections'] = df_master1['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master2['Collections'] = df_master2['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master3['Collections'] = df_master3['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master4['Collections'] = df_master4['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master5['Collections'] = df_master5['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master6['Collections'] = df_master6['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master7['Collections'] = df_master7['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master8['Collections'] = df_master8['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master9['Collections'] = df_master9['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master10['Collections'] = df_master10['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master11['Collections'] = df_master11['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master12['Collections'] = df_master12['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master13['Collections'] = df_master13['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master14['Collections'] = df_master14['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master15['Collections'] = df_master15['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master16['Collections'] = df_master16['Collections'].astype(float)
# Drop junk rows
...
# Change dtypes to Int
df_master17['Collections'] = df_master17['Collections'].astype(float)
# Drop junk rows
