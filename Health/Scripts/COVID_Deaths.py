...
df_population = df_population[["Region Code", "2019"]]
df_population = df_population.rename(
    columns={"Region Code": "GeoArea_FIPS", "2019": "Population (2019)"}
)
df_population["Population (2019)"] = df_population["Population (2019)"] * 1000
df_population[["GeoArea_FIPS", "Population (2019)"]] = df_population[
    ["GeoArea_FIPS", "Population (2019)"]
].astype(int)
...
c.execute(
    """sp_rename 'dbo.STG_NYTI_CNTY_COVID_19_Deaths','STG_NYTI_CNTY_COVID_19_Deaths_BACKUP';"""
)
