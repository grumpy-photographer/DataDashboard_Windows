...
df2 = pd.read_csv(
    "./Updates/FRED_Civilian_Labor_Force_by_County_Persons.txt", sep="\t")
...
# read education data
df4 = pd.read_csv(
    "./Updates/FRED_People_25_Years_and_Over_Who_Have_Completed_an_Associates_Degree_or_Higher_5year_estimate_by_County_Percent.txt", sep="\t")

# read pop data
df5 = pd.read_csv(
    "./Updates/FRED_Resident_Population_by_County_Thousands_of_Persons.txt", sep="\t")
